...
/***/ "./src/app/models/regisgro.model.ts":
/*!******************************************!*\
  !*** ./src/app/models/regisgro.model.ts ***!
  \******************************************/
...
/* harmony import */ var _models_regisgro_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/regisgro.model */ "./src/app/models/regisgro.model.ts");
...
var DataLocalService = /** @class */ (function () {
    function DataLocalService(storage, navController, iab, file, emailComposer) {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        nuevoRegistro = new _models_regisgro_model__WEBPACK_IMPORTED_MODULE_2__["Registro"](format, text);
    ...
    DataLocalService.prototype.abrirRegistro = function (registro) {
    ...
    DataLocalService.prototype.enviarCorreo = function () {
        var arrTemp = [];
        var titulos = 'Tipo, Formato, Creado en, Texto\n';
        arrTemp.push(titulos);
        this.guardados.forEach(function (registro) {
            var linea = registro.type + ', ' + registro.format + ', ' + registro.created + ', ' + registro.text.replace(',', ' ') + '\n';
            arrTemp.push(linea);
        });
    ...
    DataLocalService.prototype.crearArchivoFisico = function (text) {
        var _this = this;
        this.file.checkFile(this.file.dataDirectory, 'registros.csv')
            .then(function (existe) {
            console.log('Archivo Exite?', existe);
            return _this.escribirEnArchivo(text);
        })
            .catch(function (err) {
            return _this.file.createFile(_this.file.dataDirectory, 'registros.csv', true)
                .then(function (creado) { return _this.escribirEnArchivo(text); })
                .catch(function (err2) { return console.log('No se pudo crear el archivo', err2); });
        });
    };
    // tslint:disable-next-line: no-shadowed-variable
    DataLocalService.prototype.escribirEnArchivo = function (text) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var archivo, email;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.file.writeExistingFile(this.file.dataDirectory, 'registros.csv', text)];
                    case 1:
                        _a.sent();
                        console.log('Archivo creado');
                        archivo = this.file.dataDirectory + 'registros.csv';
